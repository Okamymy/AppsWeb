...
urlpatterns = [
    ...
    path('create/players/', views.CreatePlayer.as_view(), name="create_players"),
    path('list/players/', views.ListPlayer.as_view(), name="list_players"),
    path('update/players/<int:pk>/', views.UpdatePlayer.as_view(), name="update_players"),
    path('delete/players/<int:pk>/', views.DeletePlayer.as_view(), name="delete_players"),
]